            ...
            {!showCompanyDetail ? (
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  {/* Domain Management */}
                  <div className="pt-4 border-t">
                    <h3 className="text-sm font-medium mb-3">Domain Management</h3>
                    <div className="space-y-4">
                      {/* Subdomain */}
                      <div>
                        <Label htmlFor="subdomain" className="text-xs mb-1 block">Subdomain</Label>
                        <div className="flex items-center">
                          <Input
                            id="subdomain"
                            className="max-w-xs"
                          ...
                          />
                          <span className="text-sm text-muted-foreground ml-2">.atlasgrowth.ai</span>
                        </div>
                        {selectedCompany?.slug && (
                          <div className="mt-1">
                            <a 
                              href={`https://${selectedCompany.slug}.atlasgrowth.ai`} 
                              target="_blank" 
                              rel="noopener noreferrer" 
                      ...
                      {/* Custom Domain */}
                      <div>
                        <Label htmlFor="customDomain" className="text-xs mb-1 block">Custom Domain</Label>
                        <div className="flex items-center">
                          <Input
                            id="customDomain"
                            className="max-w-xs"
                            placeholder="example.com"
                            value={selectedCompany?.customDomain || ""}
                            onChange={(e) => {
                              if (selectedCompany) {
                                updateCompanyMutation.mutate({
                                  id: selectedCompany.id,
                                  updateData: { customDomain: e.target.value }
                                });
                              }
                            }}
                          />
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Client must configure DNS records as shown in the Domains tab.
                        </p>
                      </div>
                      
                      {/* Domain Status */}
                      <div>
                        <Label className="text-xs mb-1 block">Domain Status</Label>
                        <div className="flex items-center mt-1">
                          <Switch
                            checked={selectedCompany?.domainSetupComplete || false}
                            onCheckedChange={(checked: boolean) => {
                              if (selectedCompany) {
                                updateCompanyMutation.mutate({
                                  id: selectedCompany.id,
                                  updateData: { domainSetupComplete: checked }
                                });
                              }
                            }}
                          />
                          <span className="ml-2 text-sm">
                            {selectedCompany?.domainSetupComplete 
                              ? "Domain is active and working" 
                              : "Domain setup not complete"}
                          </span>
                        </div>
                      </div>
                    </div>
          ...
          <TabsContent value="domains">
            <Card>
              ...
              <CardContent className="space-y-6">
                {/* Root Domain Setup */}
                <div>
                  <h3 className="text-lg font-medium mb-2">Root Domain Setup</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Configure these DNS records for your main domain (atlasgrowth.ai)
                  </p>
                  ...
                  <div className="border rounded-md">
                    ...
                    <div className="divide-y">
                      <div className="grid grid-cols-12 p-3 text-sm">
                        ...
                        <div className="col-span-6">5.161.113.132</div>
                        <div className="col-span-2">1 Hour</div>
                      </div>
                      <div className="grid grid-cols-12 p-3 text-sm">
                        <div className="col-span-2 font-medium">CNAME</div>
                        <div className="col-span-2">www</div>
                        <div className="col-span-6">workspace-nicholas138.replit.app</div>
                        <div className="col-span-2">1 Hour</div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Subdomain Setup */}
                <div>
                  <h3 className="text-lg font-medium mb-2">Subdomain Setup</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Configure this wildcard record to enable company-specific subdomains
                  </p>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    For each company with a custom domain (not subdomain), they must configure these records
                  </p>
                ...
                {/* Domain Status */}
                <div>
                  <h3 className="text-lg font-medium mb-2">Domain Status</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Companies with custom domains or subdomains configured
                  </p>
                  ...
                  {isLoadingCompanies ? (
                    ...
                    <div className="border rounded-md">
                      ...
                      <div className="divide-y">
                        {companies?.filter(c => c.customDomain || c.slug)
                          .map(company => (
                            <div key={company.id} className="grid grid-cols-12 p-3 text-sm">
                              <div className="col-span-3 font-medium">{company.name}</div>
                              <div className="col-span-3">
                                {company.slug && (
                                  <a 
                                    href={`https://${company.slug}.atlasgrowth.ai`} 
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    className="text-blue-500 hover:underline"
                                  >
                                    {company.slug}.atlasgrowth.ai
                                  </a>
                                )}
                              </div>
                              <div className="col-span-3">
                                {company.customDomain ? (
                                  <a 
                                    href={`https://${company.customDomain}`} 
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    className="text-blue-500 hover:underline"
                                  >
                        ...
                        {companies?.filter(c => c.customDomain || c.slug).length === 0 && (
                          <div className="p-4 text-center text-sm text-muted-foreground">
                            No companies with domains configured
                          </div>
                        )}
                      </div>
                    </div>
